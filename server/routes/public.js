        ...
        <div class="project-gallery-track" data-drag-scroll-track>
          ${(otherPhotos.length > 1 ? [...otherPhotos, ...otherPhotos] : otherPhotos).map((p) => {
            ...
            <button type="button" class="project-gallery-item-view" data-lightbox-trigger data-full="${escapeHtml(p.filename)}" data-caption="${escapeHtml(p.caption || project.title)}">
              ...
              <span class="project-gallery-expand" aria-hidden="true"><svg viewBox="-4 -4 32 32" fill="currentColor"><g transform="translate(6,6) rotate(-45)"><path class="gallery-expand-arrow" d="M0,-8L5,-2L2,-2L2,6L-2,6L-2,-2L-5,-2Z"/></g><g transform="translate(18,18) rotate(135)"><path class="gallery-expand-arrow" d="M0,-8L5,-2L2,-2L2,6L-2,6L-2,-2L-5,-2Z"/></g></svg></span>
            </button>
  ...
  <section style="padding-top:0;">
    <div class="container contact-grid">
      <div class="contact-card reveal">
        ...
        ${settings.google_review_url ? `<a href="${escapeHtml(settings.google_review_url)}" class="btn btn-outline" style="margin-top:10px;display:inline-flex;align-items:center;gap:8px;" target="_blank" rel="noopener noreferrer"><svg width="16" height="16" viewBox="0 0 48 48" style="flex-shrink:0;"><path fill="#FFC107" d="M43.611,20.083H42V20H24v8h11.303c-1.649,4.657-6.08,8-11.303,8c-6.627,0-12-5.373-12-12c0-6.627,5.373-12,12-12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C12.955,4,4,12.955,4,24c0,11.045,8.955,20,20,20c11.045,0,20-8.955,20-20C44,22.659,43.862,21.35,43.611,20.083z"/><path fill="#FF3D00" d="M6.306,14.691l6.571,4.819C14.655,15.108,18.961,12,24,12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C16.318,4,9.656,8.337,6.306,14.691z"/><path fill="#4CAF50" d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36c-5.202,0-9.619-3.317-11.283-7.946l-6.522,5.025C9.505,39.556,16.227,44,24,44z"/><path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"/></svg>Avalie-nos no Google</a>` : ''}
      </div>
      <div class="contact-card reveal">
        ...
        <ul style="display:flex;flex-direction:column;gap:14px;"><li><a href="mailto:${escapeHtml(settings.contact_email || 'contato@njfilmes.com.br')}">${escapeHtml(settings.contact_email || 'contato@njfilmes.com.br')}</a></li>
          ${settings.instagram_url ? `<li><a href="${escapeHtml(settings.instagram_url)}" target="_blank" rel="noopener noreferrer" style="display:inline-flex;align-items:center;gap:6px;"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" style="opacity:0.7;flex-shrink:0;"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.012-3.584.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zm0 10.162a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm6.406-11.845a1.44 1.44 0 1 0 0 2.88 1.44 1.44 0 0 0 0-2.88z"/></svg>Instagram</a></li>` : ''}
